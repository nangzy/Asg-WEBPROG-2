            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="card mb-4 shadow rounded-4 custom-card-color" style="margin:30px; padding: 20px;">
                        <div class="card-body">
                            @for($i = 0; $i<sizeof($key); $i++) <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">
                                        {{ $key[$i] }}
                                    </p>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4 shadow rounded-4 custom-card-pop-color" style="margin: 30px; padding: 20px">
                        <div class="card-body text-center">
                            <div class="card-body text-center">
                                <button type="button" onclick="window.location='{{ url("prize/1") }}'" class="btn btn-primary btn-lg m-5 shadow">Mystery Box 7</button>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card mb-4 shadow rounded-4 custom-card-pop-color" style="margin: 30px; padding: 20px">
                        <div class="card-body text-center">
                            <div class="card-body text-center">
                                <button type="button" onclick="window.location='{{ url("prize/2") }}'" class="btn btn-success btn-lg m-5 shadow">Mystery Box 55</button>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card mb-4 shadow rounded-4 custom-card-pop-color" style="margin: 30px; padding: 20px">
                        <div class="card-body text-center">
                            <div class="card-body text-center">
                                <button type="button" onclick="window.location='{{ url("prize/3") }}'" class="btn btn-danger btn-lg m-5 shadow" >Mystery Box 10</button>
                            </div>
